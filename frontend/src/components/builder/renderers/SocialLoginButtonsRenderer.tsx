  ...
  const providers = [
    {
      ...
      url: props.googleAuthUrl || '/oauth2/authorization/google',
      text: props.googleText || 'Continue with Google',
    },
    {
      id: 'github',
      name: 'GitHub',
      ...
      url: props.githubAuthUrl || '/oauth2/authorization/github',
      text: props.githubText || 'Continue with GitHub',
    },
    {
      id: 'facebook',
      name: 'Facebook',
      ...
      url: props.facebookAuthUrl || '/oauth2/authorization/facebook',
      text: props.facebookText || 'Continue with Facebook',
    },
    {
      id: 'twitter',
      name: 'Twitter',
      ...
      url: props.twitterAuthUrl || '/oauth2/authorization/twitter',
      text: props.twitterText || 'Continue with X',
    },
    {
      id: 'linkedin',
      name: 'LinkedIn',
      ...
      url: props.linkedinAuthUrl || '/oauth2/authorization/linkedin',
      text: props.linkedinText || 'Continue with LinkedIn',
    },
    {
      id: 'apple',
      name: 'Apple',
      ...
      url: props.appleAuthUrl || '/oauth2/authorization/apple',
      text: props.appleText || 'Continue with Apple',
    },
    {
      id: 'microsoft',
      name: 'Microsoft',
      ...
      url: props.microsoftAuthUrl || '/oauth2/authorization/microsoft',
      text: props.microsoftText || 'Continue with Microsoft',
    },
  ];
    ...
    <div className="social-login-buttons" style={containerStyle}>
      {props.showDivider !== false && (
        <div className="auth-social-divider">
          <span>{props.dividerText || 'or continue with'}</span>
        </div>
      )}
