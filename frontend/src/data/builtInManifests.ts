...
const pageLayoutManifest: ComponentManifest = {
  ...
  configurableProps: [
    ...
    {
      name: 'mobileSidebarBehavior',
      type: PropType.SELECT,
      label: 'Mobile Sidebar Behavior',
      defaultValue: 'hidden',
      options: ['hidden', 'stacked', 'overlay'],
      helpText: 'How sidebar behaves on mobile: hidden (completely hidden), stacked (above content), or overlay (slide-out drawer with hamburger menu)',
    },
  ],
  configurableStyles: [],
  sizeConstraints: {
