package dev.mainul35.plugins.flashcard;

import dev.mainul35.cms.sdk.Plugin;
import dev.mainul35.cms.sdk.PluginContext;
import org.slf4j.Logger;

public class FlashcardPlugin implements Plugin {

    private static final String PLUGIN_ID = "flashcard-plugin";
    private static final String VERSION = "1.0.0";
    private static final String NAME = "Flashcard Plugin";
    private static final String DESCRIPTION = "Provides flashcard, deck, and study session management";
